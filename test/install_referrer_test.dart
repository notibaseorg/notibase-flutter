...
///
/// What is NOT here is `configure()` reading the referrer for itself. That
/// runs through a platform channel, `configure` is one-shot per process by
/// design, and the read is private — a unit test of it would end up
/// asserting values the test had just written, which is a test that passes
/// whatever the code does. The automatic path is exercised by the
/// flutter-sdk workflow and on a real handset; the parsing, which is where
/// a silent mistake would actually live, is exercised here.
